...
ifeq ($(config),release_x64)
  ...
  TARGET = $(TARGETDIR)/example-travel
  OBJDIR = .build/obj/x64/release/example-travel
  DEFINES += -DNDEBUG
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
...
ifeq ($(config),release_x32)
  ...
  TARGET = $(TARGETDIR)/example-travel
  OBJDIR = .build/obj/x32/release/example-travel
  DEFINES += -DNDEBUG
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x64)
  ...
  TARGET = $(TARGETDIR)/example-travel
  OBJDIR = .build/obj/x64/debug/example-travel
  DEFINES +=
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x32)
  ...
  TARGET = $(TARGETDIR)/example-travel
  OBJDIR = .build/obj/x32/debug/example-travel
  DEFINES +=
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/travel.o: examples/travel.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/travel.main.o: examples/travel.main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
