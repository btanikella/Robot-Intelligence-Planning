...
struct p4_state
{
	...
	at_tuple* at_5;
	top_tuple* top_6;
	on_table_tuple* on_table_7;
	on_other_tuple* on_other_8;
	int stage;
};
				...
				for (state.loc_3 = tuple_list::head<loc_tuple>(world.atoms[atom_loc]); state.loc_3 != 0; state.loc_3 = state.loc_3->next)
				{
					...
					for (state.at_4 = tuple_list::head<at_tuple>(world.atoms[atom_at]); state.at_4 != 0; state.at_4 = state.at_4->next)
					{
						...
						for (state.at_5 = tuple_list::head<at_tuple>(world.atoms[atom_at]); state.at_5 != 0; state.at_5 = state.at_5->next)
						{
							...
							state._4 = state.at_5->_0;

							for (state.top_6 = tuple_list::head<top_tuple>(world.atoms[atom_top]); state.top_6 != 0; state.top_6 = state.top_6->next)
							{
								if (state.top_6->_0 != state._0)
								{
									continue;
								}

								for (state.on_table_7 = tuple_list::head<on_table_tuple>(world.atoms[atom_on_table]); state.on_table_7 != 0; state.on_table_7 = state.on_table_7->next)
								{
									if (state.on_table_7->_0 != state._0)
									{
										continue;
									}

									for (state.on_other_8 = tuple_list::head<on_other_tuple>(world.atoms[atom_on_other]); state.on_other_8 != 0; state.on_other_8 = state.on_other_8->next)
									{
										if (state.on_other_8->_0 != state._4)
										{
											continue;
										}

										PLNNR_COROUTINE_YIELD(state, 9);
									}
								}
							}
						}
	...
	for (state.disc_0 = tuple_list::head<disc_tuple>(world.atoms[atom_disc]); state.disc_0 != 0; state.disc_0 = state.disc_0->next)
	{
		...
		for (state.loc_1 = tuple_list::head<loc_tuple>(world.atoms[atom_loc]); state.loc_1 != 0; state.loc_1 = state.loc_1->next)
		{
			...
			for (state.loc_2 = tuple_list::head<loc_tuple>(world.atoms[atom_loc]); state.loc_2 != 0; state.loc_2 = state.loc_2->next)
			{
                cout << "1????????????????????????" << endl;
                cout << "N5 5" << endl;
                cout << state.loc_2 << endl;
                cout << state.loc_2->_0 << endl;
                cout << state._2 << endl;
					...
					for (state.at_4 = tuple_list::head<at_tuple>(world.atoms[atom_at]); state.at_4 != 0; state.at_4 = state.at_4->next)
					{
						...
						for (state.at_5 = tuple_list::head<at_tuple>(world.atoms[atom_at]); state.at_5 != 0; state.at_5 = state.at_5->next)
						{
							...
							for (state.top_6 = tuple_list::head<top_tuple>(world.atoms[atom_top]); state.top_6 != 0; state.top_6 = state.top_6->next)
							{
								...
								for (state.on_7 = tuple_list::head<on_tuple>(world.atoms[atom_on]); state.on_7 != 0; state.on_7 = state.on_7->next)
								{
									if (state.on_7->_0 != state._0)
									{
										continue;
									}

									state._5 = state.on_7->_1;

									for (state.on_other_8 = tuple_list::head<on_other_tuple>(world.atoms[atom_on_other]); state.on_other_8 != 0; state.on_other_8 = state.on_other_8->next)
									{
										state._6 = state.on_other_8->_0;
            ...
            cout << tuple_list::head<loc_tuple>(world.atoms[atom_loc]) << endl;
            
            cout << "HERE 2" << endl;
            
            cout << state.loc_1 << endl; 
            cout << "HERE 3" << endl;

            
            cout << "*" << state.loc_1->next << "*" << endl;
            cout << "HERE 4" << endl;

            
            //state.loc_1 = state.loc_1->next;
            cout << "HERE 5" << endl;
