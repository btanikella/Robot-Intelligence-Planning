...
ifeq ($(config),release_x64)
  ...
  TARGET = $(TARGETDIR)/hanoi
  OBJDIR = .build/obj/x64/release/hanoi
  DEFINES += -DNDEBUG
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
...
ifeq ($(config),release_x32)
  ...
  TARGET = $(TARGETDIR)/hanoi
  OBJDIR = .build/obj/x32/release/hanoi
  DEFINES += -DNDEBUG
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x64)
  ...
  TARGET = $(TARGETDIR)/hanoi
  OBJDIR = .build/obj/x64/debug/hanoi
  DEFINES +=
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug_x32)
  ...
  TARGET = $(TARGETDIR)/hanoi
  OBJDIR = .build/obj/x32/debug/hanoi
  DEFINES +=
  INCLUDES += -Iinclude
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/hanoi.o: examples/hanoi.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/hanoi.main.o: examples/hanoi.main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
